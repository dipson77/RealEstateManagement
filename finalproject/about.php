    ...
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: tomato;">
     ...
     <div class="jumbotron jumbotron-fluid">
        <div class="container-fluid">
            ...
            <p>Gandaki Nirman Pvt. Ltd. is one of the Nepal leading overseas property portals. Listings represented in our database are provided by owners or landlords on the advertisement basis. We are not the owners of the represented objects, agency or developer and do not take a commission from buyers or owners.</p>
      ...
      <div class="jumbotron jumbotron-fluid" style="margin: 0px;">
        <div class="container-fluid">
            <h1 class="display-3">Why to choose us?</h1>
           
            <div class="row">
                <div class="col-md-8">
                    <p>Selecting a trusted partner to provide market research and advice can be a difficult task: you need to balance rigor, service, and resourcing constraints - all while ensuring the vendor will provide you with accurate, clear data, and insights.</p>
                </div>
      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-md-9">
                ...
                <h2>Our Vision</h2>
                <p>Our vision is to be the leading real estate service provider in the region and the preferred place of employment for real estate professionals. We consistently strive to develop collaborative partnerships, based on transparency and mutual trust, which serve to build enduring client relationships. As we expand, we're committed to these principles, which have served our company and clients through the years.</p>
                <div class="col-md-4">
                    <img src="images/second.png" alt="photo" class="img-thumbnail">
                </div>
