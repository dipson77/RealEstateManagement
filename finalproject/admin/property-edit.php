  ...
  <body>
   ...
   <div class="container-fluid " style="padding:30px" >
    ...
    <div class="col-md-4" style="background-color: lightblue" >
       ...
       <h2 class="disp;ay-4">Update Properties</h2>
       <form action="update-property.php" method="get" enctype="multipart/form-data">
        <div class="form-group">
          <label for="ID">ID:</label>
          <input type="text" name="pid1" id="pid1" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo $_GET['pid']; ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" name="location1" id="location1" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo $_GET['location']; ?>">
          
        </div>

        <div class="form-group">
          <label for="price">Price</label>
          <input type="number" name="price1" id="price1" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo $_GET['price']; ?>">
        ...
        <!-- Delete -->
        <button type="submit" class="btn btn-info btn-lg" name="submit">Update Properties</button> 
