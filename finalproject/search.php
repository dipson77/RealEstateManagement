 ...
 <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: tomato;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link btn-outline-success" href="admit.php">Buying</a>
                </li>
 ...
 <div class="container" style="padding: 30px;">
        <h2 class="display-4 text-center">Featured Properties</h2>
        <hr class="my-2">
        <div class="row">
        <?php
                include 'admin/connection.php';
                $query="select * from property order by rand() LIMIT 6";
            ...
            <div class="col-md-4">
                ...
                <img src="images/<?php echo $d; ?>" alt="web" class="img-thumbnail">
                 <br><br>       
                <p><a class="btn-lg btn-primary" href="#" role="button">Price: $ <?php echo $c; ?> </a></p>
                
                <p><a class="btn-lg btn-primary" href="#" role="button">Location: <?php echo $e; ?> </a></p>
                <a href="post.php?id=<?php echo $a; ?>" class="btn btn-success btn-lg">Buy Now</a>
            </div>
            <?php
                }
                ?>
