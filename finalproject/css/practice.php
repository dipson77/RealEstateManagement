...
<html lang="en">
  <head>
    <title>Dipson Media Creation</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="" content="Dipson Media Creation, about us, contact us, gallery, admit now">
    <!-- Bootstrap CSS -->
  ...
  <body>
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: tomato;">
        <a class="navbar-brand" href="index.php">Dipson Media Creation</a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="admit.php" class="btn btn-outline-success my-2 my-sm-0" >Admission Open</a>
            </form>
        </div>
    </nav>
   ...
   <div class="container-fluid">
      ...
      <div class="jumbotron jumbotron-fluid" style="margin: 0px;">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit quos natus sunt non incidunt, minima ipsa facilis illo in. Perspiciatis sed voluptatum suscipit exercitationem numquam ad vitae minus! Alias, dolore!</p>
                </div>
                <div class="col-md-4">
                    <img src="images/logo.png" alt="why-us?" class="img-thumbnail">
                </div>
            </div>
            ...
            <div class="col-md-9">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="address" name="address" id="address" class="form-control" placeholder="Address" aria-describedby="helpId">
                      
                    </div>
                    <div class="form-group">
                      <label for="phone">Phone:</label>
                      <input type="number" name="phone" id="phone" class="form-control" placeholder="+977-98----------" aria-describedby="helpId">
                    ...
                    <div class="form-group">
                      ...
                      <!-- submit b4 form  -->
                    <button type="submit" class="btn btn-success btn-lg" name="submit">Send Query</button>
                    <!-- Reset b4 form -->
      ...
      <div class="container-fluid" style="padding: 20px; background-color: brown; color: gold;">
        <div class="container">
            ...
            <div class="col-md-4">
                <h3 Contact Us></h3>
                <p>Dipson Media Creation</p>
                <p>Bharatpur, Chitwan</p>
                <p>Nepal</p>
                <p>Managing Director <br>
                    Rose Shrestha</p>
                <p> phone:+977 9807249428</p>
                <p>Info: dipson769@gmail.com</p>
            ...
            <p class="text-center">All right reserved @Dipson Media Creation. </p>
        </div>
